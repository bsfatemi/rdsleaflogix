...
# SOURCE ------------------------------------------------------------------
source(
  "inst/pipeline/appdata/polaris/polaris_appdata/custom/fstreet/src/build_fstreet_polaris.R",
  local = TRUE
)
...
#  POLARIS-APPDATA ---------------------------------------------------------------
polaris <- build_fstreet_polaris(customers, customer_behavior, abandoned_carts)
